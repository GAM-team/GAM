...
# Command line arguments
  ...
  ARG_GELICENSE = 'gelicense'
  ARG_GELICENSES = 'gelicenses'
  ARG_GESUBSCRIPTION = 'gesubscription'
  ARG_GESUBSCRIPTIONS = 'gesubscriptions'
  ARG_GEUSERSTORE = 'geuserstore'
  ARG_GMAIL = 'gmail'
  ...
  ARG_SCHEMA = 'schema'
  ARG_SCHEMAS = 'schemas'
  ARG_SCIMCONFIG = 'scimconfig'
  ARG_SCIMGROUP = 'scimgroup'
  ARG_SCIMGROUPS = 'scimgroups'
  ARG_SCIMRESOURCETYPE = 'scimresourcetype'
  ARG_SCIMRESOURCETYPES = 'scimresourcetypes'
  ARG_SCIMSCHEMA = 'scimschema'
  ARG_SCIMSCHEMAS = 'scimschemas'
  ARG_SCIMUSER = 'scimuser'
  ARG_SCIMUSERS = 'scimusers'
  ARG_SECCALS = 'seccals'
  ARG_SENDAS = 'sendas'
