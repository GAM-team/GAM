...
from gam.cmd.scim import (
    doCreateSCIMGroup,
    doCreateSCIMUser,
    doDeleteSCIMGroup,
    doDeleteSCIMUser,
    doInfoSCIMGroup,
    doInfoSCIMResourceType,
    doInfoSCIMSchema,
    doInfoSCIMUser,
    doPrintShowSCIMGroups,
    doPrintShowSCIMResourceTypes,
    doPrintShowSCIMSchemas,
    doPrintShowSCIMUsers,
    doShowSCIMConfig,
    doUpdateSCIMGroup,
    doUpdateSCIMUser,
)
...
MAIN_ADD_CREATE_FUNCTIONS = {
  ...
  Cmd.ARG_SCIMGROUP:		doCreateSCIMGroup,
  Cmd.ARG_SCIMUSER:		doCreateSCIMUser,
  ...
  'delete':
    (Act.DELETE,
     {Cmd.ARG_ADMIN:		doDeleteAdmin,
      ...
      Cmd.ARG_SCIMGROUP:	doDeleteSCIMGroup,
      Cmd.ARG_SCIMUSER:	doDeleteSCIMUser,
  ...
  'info':
    (Act.INFO,
     {Cmd.ARG_ADMINROLE:	doInfoPrintShowAdminRoles,
      ...
      Cmd.ARG_SCIMGROUP:	doInfoSCIMGroup,
      Cmd.ARG_SCIMRESOURCETYPE:	doInfoSCIMResourceType,
      Cmd.ARG_SCIMSCHEMA:	doInfoSCIMSchema,
      Cmd.ARG_SCIMUSER:	doInfoSCIMUser,
  ...
  'print':
    (Act.PRINT,
     {Cmd.ARG_ADDRESSES:	doPrintAddresses,
      ...
      Cmd.ARG_SCIMGROUPS:	doPrintShowSCIMGroups,
      Cmd.ARG_SCIMRESOURCETYPES:	doPrintShowSCIMResourceTypes,
      Cmd.ARG_SCIMSCHEMAS:	doPrintShowSCIMSchemas,
      Cmd.ARG_SCIMUSERS:	doPrintShowSCIMUsers,
  ...
  'show':
    (Act.SHOW,
     {Cmd.ARG_ADMINROLE:	doInfoPrintShowAdminRoles,
      ...
      Cmd.ARG_SCHEMA:		doPrintShowUserSchemas,
      Cmd.ARG_SCIMCONFIG:	doShowSCIMConfig,
      Cmd.ARG_SCIMGROUPS:	doPrintShowSCIMGroups,
      Cmd.ARG_SCIMRESOURCETYPES:	doPrintShowSCIMResourceTypes,
      Cmd.ARG_SCIMSCHEMAS:	doPrintShowSCIMSchemas,
      Cmd.ARG_SCIMUSERS:	doPrintShowSCIMUsers,
  ...
  'update':
    (Act.UPDATE,
     {Cmd.ARG_ADMINROLE:	doCreateUpdateAdminRoles,
      ...
      Cmd.ARG_SCHEMA:		doCreateUpdateUserSchemas,
      Cmd.ARG_SCIMGROUP:	doUpdateSCIMGroup,
      Cmd.ARG_SCIMUSER:	doUpdateSCIMUser,
...
MAIN_COMMANDS_OBJ_ALIASES = {
  ...
  Cmd.ARG_SCIMGROUPS:		Cmd.ARG_SCIMGROUP,
  Cmd.ARG_SCIMUSERS:		Cmd.ARG_SCIMUSER,
