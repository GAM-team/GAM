...
# ACL choices
  'whoCanAdd': 'list',
  'whoCanApproveMembers': 'list',
  'whoCanApproveMessages': 'list',
  'whoCanAssignTopics': 'list',
  'whoCanAssistContent': 'list',
  'whoCanBanUsers': 'list',
  'whoCanContactOwner': 'list',
  'whoCanDeleteAnyPost': 'list',
  'whoCanDeleteTopics': 'list',
  'whoCanDiscoverGroup': 'list',
  'whoCanEnterFreeFormTags': 'list',
  'whoCanHideAbuse': 'list',
  'whoCanInvite': 'list',
  'whoCanJoin': 'list',
  'whoCanLeaveGroup': 'list',
  'whoCanLockTopics': 'list',
  'whoCanMakeTopicsSticky': 'list',
  'whoCanMarkDuplicate': 'list',
  'whoCanMarkFavoriteReplyOnAnyTopic': 'list',
  'whoCanMarkFavoriteReplyOnOwnTopic': 'list',
  'whoCanMarkNoResponseNeeded': 'list',
  'whoCanModerateContent': 'list',
  'whoCanModerateMembers': 'list',
  'whoCanModifyMembers': 'list',
  'whoCanModifyTagsAndCategories': 'list',
  'whoCanMoveTopicsIn': 'list',
  'whoCanMoveTopicsOut': 'list',
  'whoCanPostAnnouncements': 'list',
  'whoCanPostMessage': 'list',
  'whoCanTakeTopics': 'list',
  'whoCanUnassignTopic': 'list',
  'whoCanUnmarkFavoriteReplyOnAnyTopic': 'list',
  'whoCanViewGroup': 'list',
  'whoCanViewMembership': 'list',
# Miscellaneous hoices
  'messageModerationLevel': 'list',
  'replyTo': 'list',
  'spamModerationLevel': 'list',
# Booleans
  'allowExternalMembers': 'bool',
  'allowGoogleCommunication': 'bool',
  'allowWebPosting': 'bool',
  'archiveOnly': 'bool',
  'enableCollaborativeInbox': 'bool',
  'favoriteRepliesOnTop': 'bool',
  'includeCustomFooter': 'bool',
  'includeInGlobalAddressList': 'bool',
  'isArchived': 'bool',
  'membersCanPostAsTheGroup': 'bool',
  'sendMessageDenyNotification': 'bool',
  'showInGroupDirectory': 'bool',
  }
